...
public class ModBlocks {
    ...
    // Finding 3: Register without block item — graves are only placed programmatically
    // Finding 4: Use bedrock-like strength to prevent all destruction methods
    public static final Block GRAVESTONE = registerBlockWithoutBlockItem("gravestone",
            new GravestoneBlock(
                    AbstractBlock.Settings.create().registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(ReviveGraves.MOD_ID,"gravestone")))
